...
export costs_dataframe, mr_dataframe
...
function mr_dataframe( mr1::Histogram, mr2::Histogram, mean1::Real, mean2 :: Real, median1::Real, median2 :: Real ) :: DataFrame
    ...
    df = DataFrame( Item=METR_TABLE_BREAK_LABELS[2:end-2], Before=mr1.weights, After=mr2.weights, Change=change)
    mchange = mean2 - mean1
...
function pov_dataframe( 
    ...
    names = ["Headcount (All)", "Child Poverty", "Gap", "Poverty Severity", "Watts", "Sen", "Shorrocks"]
